...
public class MiddleClickInfo extends Module {
    ...
    public MiddleClickInfo() {
        super(Eclipse.UTILITY, "middle-click-info", "Middle-click players to add them as friends, or inspect blocks and entities.");
    }
    ...
    private void inspectEntity(Entity entity) {
        if (entity instanceof PlayerEntity player) {
            ...
            if (Friends.get().add(friend)) {
                EclipseToastOverlay.show("Friend added", player.getName().getString(), player, FRIEND_ACCENT);
            } else {
                EclipseToastOverlay.show("Already a friend", player.getName().getString(), player, FRIEND_ACCENT);
            }
            return;
        }
        ...
        if (entity instanceof LivingEntity living) {
            EclipseToastOverlay.show("Entity: " + name, id, living, ENTITY_ACCENT);
        } else {
