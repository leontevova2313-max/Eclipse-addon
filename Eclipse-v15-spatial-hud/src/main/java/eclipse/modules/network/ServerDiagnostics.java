...
public class ServerDiagnostics extends Module {
    ...
    public ServerDiagnostics() {
        super(Eclipse.NETWORK, "server-diagnostics", "Structured server diagnostics for corrections, packets, interactions, module context, and session summaries.");
    }
    ...
    private String activeModuleSnapshot() {
        ...
        return Modules.get().getActive().stream()
            .filter(module -> Eclipse.isEclipseCategory(module.category))
