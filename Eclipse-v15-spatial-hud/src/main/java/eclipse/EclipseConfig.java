...
public final class EclipseConfig {
    ...
    private static boolean visualsActive = false;
    ...
    private static boolean noViewBob = false;
    private static boolean noHurtTilt = false;

    private EclipseConfig() {
    }

    public static boolean titleBackground() {
        return visualsActive && titleBackground;
    }
    ...
    public static boolean titleLogo() {
        return visualsActive && titleLogo;
    }
    ...
    public static boolean customTitleBackground() {
        return visualsActive && customTitleBackground && customTitleBackgroundTexture != null;
    }
    ...
    public static boolean screenBackgrounds() {
        return visualsActive && screenBackgrounds;
    }
    ...
    public static boolean visualsActive() {
        return visualsActive;
    }

    public static void visualsActive(boolean value) {
        visualsActive = value;
    }
    ...
    public static boolean noViewBob() {
        return cameraTweaksActive && noViewBob;
    }

    public static void noViewBob(boolean value) {
        noViewBob = value;
    }

    public static boolean noHurtTilt() {
        return cameraTweaksActive && noHurtTilt;
    }

    public static void noHurtTilt(boolean value) {
        noHurtTilt = value;
    }
