...
public class LitematicaPrinter extends Module {
    ...
    public LitematicaPrinter() {
        super(Eclipse.CATEGORY, "litematica-printer", "Prints the loaded Litematica schematic with server-aware placement pacing.");
    }
    ...
    private FindItemResult findHotbarOrMove(Predicate<ItemStack> predicate) {
        ...
        moveCooldown = moveCooldownSetting.get();
    ...
    private RotationSpec getStateRotation(BlockState state) {
        ...
        return switch (direction) {
            case SOUTH -> new RotationSpec(0.0, mc.player.getPitch());
            case WEST -> new RotationSpec(90.0, mc.player.getPitch());
            case NORTH -> new RotationSpec(180.0, mc.player.getPitch());
            case EAST -> new RotationSpec(-90.0, mc.player.getPitch());
